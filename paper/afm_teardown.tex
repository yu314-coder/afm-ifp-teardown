...
The router is Apple's, extracted---not a trained mimic.
...
confirmed \emph{variable} ($42$--$232$ experts/constant, no uniform width). The
\code{metadata.\allowbreak bin} \code{BBBB} swizzler indexes the attention region only (its maximum
offset equals $\mathtt{0xC0C8000}$, exactly the start of the expert region).
